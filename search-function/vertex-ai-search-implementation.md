...
Collect information from all markdown files, PRs, Issues, and Discussions within
  ...
  -d '{                     
    "structSchema": {                                      
      ...
      "properties": {                
        ...
        "content":      { "type": "string", "keyPropertyMapping": "description", "retrievable": true },
        ...
        "references":   {
          ...
          "type": "object",
            "properties": {
              "raw_text":   { "type": "string", "indexable": true},
  ...
  -d '{
    "structSchema": {
      ...
      "properties": {
        ...
        "jsonData": {
          ...
          "properties": {
            ...
            "type": {
              ...
              "indexable": true,
              "retrievable": true,
              "description": "Document type (pr, issue, discussion, markdown)"
            },
            "labels": {
              "type": "ARRAY",
              "indexable": true,
            ...
            "status": {
              ...
              "indexable": true,
              "retrievable": true,
              "description": "Status (open, closed, merged, etc.)"
            },
            "author": {
              "type": "STRING",
              "indexable": true,
        ...
        "structData": {
          "type": "OBJECT",
          "description": "Document structure and references",
          "properties": {
            "url": {
              "type": "STRING",
              "indexable": false,
            ...
            "references": {
              ...
              "indexable": false,
              "retrievable": true,
              "description": "Array of extracted references",
              "elements": {
                "type": "OBJECT",
                "properties": {
                  "raw_text": {
                    ...
                    "indexable": true,
                    "retrievable": true,
                    "description": "Raw reference text from markdown"
                  },
                  "target_url": {
                    "type": "STRING",
                    "indexable": false,
                    "retrievable": true,
                    "description": "Resolved target URL"
                  }
                }
              }
            }
